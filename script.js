$(document).ready(function () {
    ...
    weatherSearch(lastSearchedCity);
    ...
    function getForecast(searchValue) {  
        $.ajax({
            ...
            $(".card-title-1").text(data.list[7].dt_txt); 
...
// function calling on api and params, etc.
    function getUV(lat, lon, data) {
        $.ajax({
            method: "GET",
            url: "https://api.openweathermap.org/data/2.5/uvi?appid=a468ca0d8bd9b0455127f58ae98ac8b8&lat=" + lat + "&lon=" + lon}).done(function (uvData){
